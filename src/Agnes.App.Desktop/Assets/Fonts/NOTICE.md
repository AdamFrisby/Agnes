...
identical everywhere — a bare Linux box ships none of them, and macOS/Windows would each substitute
something different. (Same set, same reason, as `Agnes.App.Mobile/Assets/Fonts`.)
